...
class CamelQuiz extends React.Component {
  componentDidMount() {
    ...
    return (
      <div>
        ...
        <div className="score__container">
          ...
          <h3 className="score">{this.props.camelScore}</h3>
        </div>
        <div className="lives__container">
          <p> Lives Remaining :</p>
          <h3 className="lives">{this.props.wrongCamel}/3</h3>
        </div>
      </div>
    );
  }
